...
MOCK_IDENTITY_REGISTRY: dict[str, RegistryRecord] = {
    ...
    "563613493016": RegistryRecord(
        document_id="563613493016",
        name="Anand Hemant Kamble",
        date_of_birth="24/09/2006",
        nationality="IND",
        status="active",
    ),
    ...
    "MAVPK5195B": RegistryRecord(
        document_id="MAVPK5195B",
        name="Anand Hemant Kamble",
        date_of_birth="24/09/2006",
        nationality="IND",
        status="active",
    ),
    "MH1020250008848": RegistryRecord(
        document_id="MH1020250008848",
        name="VARDHAK SUNIL PATIL",
        date_of_birth="25-01-2006",
        nationality="IND",
        status="active",
    ),
}
